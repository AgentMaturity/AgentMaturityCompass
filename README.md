...
| Tier | What you get |
|---|---|
| **Free / Open Source** | Everything — Score, Shield, Enforce, Vault, Watch, Comply, Fleet, Passport, all 15 adapters, 1,170 registered CLI command paths, browser playground, CI gates |
...
| [CLI Reference (1,170 command paths)](docs/CLI_COMMAND_INVENTORY.md) | [Architecture](docs/ARCHITECTURE_MAP.md) |
...
<p align="center">
  <strong>244 default diagnostic questions + 20 lifecycle expansion questions · 142 assurance packs · 41 domain packs · 15 adapters · 1,170 CLI command paths</strong><br>
