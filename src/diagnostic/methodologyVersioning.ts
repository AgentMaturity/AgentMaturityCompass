...
export function buildDiagnosticMethodologyVersioningReceipt(
  ...
  const receiptWithoutHash = {
    ...
    evidenceRefs: ["amc:public-methodology", "amc:badge-methodology-binding", "amc:diagnostic-methodology-versioning", "amc:agent-belt-methodology-assurance", "amc:arize-phoenix-source-review-boundary", "amc:lunary-source-review-boundary", "amc:fact-checking-factuality-review-methodology-boundary", "amc:google-adk-source-review-boundary", "amc:openai-evals-public-methodology-boundary", "amc:pocketflow-public-methodology-boundary", "amc:digital-materials-ecosystem-source-review-boundary", "amc:chemgraph-agentic-chemistry-workflow-source-review-boundary", "amc:lm-evaluation-harness-source-review-boundary", "amc:openai-simple-evals-source-review-boundary"],
