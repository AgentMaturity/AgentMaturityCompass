...
export function buildDiagnosticMethodologyVersioningReceipt(
  ...
  const receiptWithoutHash = {
    ...
    evidenceRefs: ["amc:public-methodology", "amc:badge-methodology-binding", "amc:diagnostic-methodology-versioning", "amc:agent-belt-methodology-assurance", "amc:arize-phoenix-source-review-boundary", "amc:lunary-source-review-boundary", "amc:fact-checking-factuality-review-methodology-boundary", "amc:google-adk-source-review-boundary", "amc:openai-evals-public-methodology-boundary", "amc:digital-materials-ecosystem-source-review-boundary", "amc:chemgraph-agentic-chemistry-workflow-source-review-boundary", "amc:lm-evaluation-harness-source-review-boundary"],
    rejectedEvidenceRefs: ["metadata-only:kiosvantra/metronous", "metadata-only:sutro-sh/sutro", "metadata-only:jfrog/agent-belt", "metadata-only:phoenix.arize.com", "metadata-only:lunary.ai", "metadata-only:doi:10.1007/s10462-025-11454-w", "metadata-only:openalex:W7118132038", "metadata-only:google/adk-python", "metadata-only:openai/evals", "metadata-only:doi-10.1039/d5sc09229a", "metadata-only:openalex-W7131071926", "metadata-only:doi-10.1038/s42004-025-01776-9", "metadata-only:openalex-W7119161162", "metadata-only:EleutherAI/lm-evaluation-harness"],
