...
export const AMC_PUBLIC_METHODOLOGY_VERSION = "2026.06.20-r212";
...
export function getPublicMethodologyManifest(questionSet?: DiagnosticQuestionSetInfo): PublicMethodologyManifest {
  const manifestWithoutHash = {
    ...
    deprecationNotice: "Reports and badges that do not include methodology.id, methodology.version, methodology.hash, and questionSet.version are legacy outputs and should not be used as current external proof. Reports generated before 2026.06.20-r212 must not present Arize Phoenix/AX-style tracing, evaluator, dataset, experiment, annotation, monitoring, alert, or metric-validity claims as externally comparable proof without a fresh methodology block, signed evidence refs, fail-closed threshold policy, and no-copy/source-review receipt.",
    migrationGuidance: [
