  ...
  root.innerHTML = `
    ...
    <section class="card studio-desktop-note">
      <div>
        ...
        <p class="muted">
          The macOS app now starts local demo-mode Studio and renders this Console inside a native WebKit window. Windows still launches the same local URL in the system browser. Both keep the same flow: 244 default questions, 264 lifecycle questions, 142 assurance packs, 41 Industry Packs, and 1,170 CLI paths.
        </p>
      </div>
      <div class="row wrap">
