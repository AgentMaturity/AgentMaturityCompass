...
const ONBOARD_STEPS = [
  ...
  { icon: '🏭', title: 'Industry Domains', body: '<strong>41 industry packs</strong> across 7 domains (Health, Education, Environment, Mobility, Governance, Technology, Wealth). Industry Packs are $9.99/month per user for all 41 packs. Click <strong>Domains</strong> in the sidebar to browse and unlock them.' },
