...
const CURRENT_TEST_COUNT = "8,229";
const CURRENT_TEST_FILE_COUNT = "1,043";
const STALE_TEST_COUNTS = ["8,223", "8%2C223", "8,218", "8%2C218", "8,212", "8%2C212", "8,207", "8%2C207", "8,206", "8%2C206", "8,198", "8%2C198", "8,191", "8%2C191", "8,175", "8%2C175", "8,164", "8%2C164", "8,158", "8%2C158", "8,150", "8%2C150", "5,394", "5%2C394", "5,098", "5%2C031", "4,161", "3,980", "2,723", "2,699"];
...
describe("public test-count claims", () => {
  ...
  test("README badge uses the latest fully verified passing inventory", () => {
    ...
    expect(readme).toContain("tests-8%2C229%20passing");
    expect(readme).not.toContain("tests-8%2C229%20collected");
  });
});
