...
describe("public methodology manifest", () => {
  test("publishes a deterministic public methodology id, version, and hash", () => {
    ...
    expect(first.deprecationNotice).toContain("2026.07.10-r222");
    expect(first.deprecationNotice).toContain("different public and diagnostic methodology assurance hashes");
