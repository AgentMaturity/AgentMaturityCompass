...
We evaluate AMC through two primary case studies and one controlled anti-gaming experiment. All evaluations were conducted on production-equivalent agent instances running on the AMC platform. The platform's 1130 modules span six packages, validated by 8,207 passing Vitest tests across 1,039 files:
...
Platform validation inventory: 8,207 passing Vitest tests across 1,039 files as of the current repository audit, covering cross-package interfaces, the end-to-end scoring pipeline, research-backed scoring modules, and 142 assurance packs.
