...
const ALL_DOCS = [
  ...
  'CLI_COMMAND_INVENTORY','CLI_WRAPPERS','CLOUD_REFERENCE_ARCHITECTURES','COMPLIANCE','COMPLIANCE_FRAMEWORKS','COMPLIANCE_MAPS','CONNECT','CONSOLE','CONTEXT_GRAPH','CONTROL_PROJECTION','CONTROL_SIMULATION','CUSTOM_ADAPTER',
  ...
  content.innerHTML = `
    <div class="welcome">
      ...
      <div class="stat-grid">
        ...
        <div class="stat-card"><div class="num">1,170</div><div class="label">CLI Paths</div></div>
