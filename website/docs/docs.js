...
const CATEGORIES = [
  ...
  },
  {
    name: 'Product & UX',
    icon: '🎨',
    docs: ['CONSOLE', 'DASHBOARD', 'STUDIO', 'TOOLHUB', 'PLUGINS', 'SANDBOX', 'WHATIF', 'PLAYGROUND', 'DOMAIN_PACKS', 'SECTOR_PACKS', 'BUNDLES', 'CASEBOOKS', 'ORG_COMPASS', 'ORG_EOC', 'UX_COUNCIL_REPORT', 'REAL_PEOPLE_COUNCIL', 'NORTHSTAR_PROMPTS', 'PRODUCT_EDITIONS', 'PRICING', 'BUYER_PACKAGES', 'SERVICES_AND_SUPPORT', 'BENCHMARK_GALLERY', 'COMMUNITY_SHOWCASE', 'RELEASE_HIGHLIGHTS']
  },
  {
    name: 'API Reference',
    icon: '📡',
