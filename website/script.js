...
var PRODUCTS=[
  ...
  {name:'amc shield',title:'Shield',headline:'Attack your agent before attackers do',summary:'Runs adversarial packs and controlled confirmation lanes against prompt injection, leakage, memory poisoning, and sycophancy.',badges:['142 assurance packs','authorized confirmation','safe proof'],info:[{label:'what it does',title:'Pressure-tests the runtime',text:'Executes attack scenarios against your actual prompt, tool, and memory surface.'},{label:'why it matters',title:'Finds brittle defenses fast',text:'One missed path can turn a polished demo into a production incident.'},{label:'output',title:'Pack report + safe proof',text:'Returns failing probes, redacted confirmation proof, and generated mitigation configs.'}],lines:[
