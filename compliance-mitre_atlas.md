# AMC Compliance Report (MITRE_ATLAS)

- Agent: default
- Window: 2026-02-13T08:51:51.737Z -> 2026-03-15T08:51:51.737Z
- Config trusted: NO (compliance maps signature missing)
- Trust coverage: OBSERVED 100.0% | ATTESTED 0.0% | SELF_REPORTED 0.0%
- Coverage score: 50.0% (S:0 P:8 M:0 U:0)

## Categories

### Reconnaissance (PARTIAL)

Adversary gathers information about ML system architecture, capabilities, and attack surface.

Deterministic reasons:
- Found 7146 matching events with observed ratio 1.000
- Found denied audit events: UNSAFE_PROVIDER_ROUTE, MODEL_ROUTE_MISMATCH
Evidence references:
...
- 3cae6c72-4d38-4c21-8eae-7b8bd6ac7e48 (audit) hash=a007c67ca1b9646572e92299c9056e0124d3c9f0859a8254d15c3d010d56fb14
- 2b6b6207-178e-4ef0-97f6-5d4384c562fb (audit) hash=ed570375b26b80e562a00198b65a9d51c5fbf0ef123aaa6584f2fc35c9668278
- f20a54d1-29f1-4f38-b21e-c139647fc4ad (audit) hash=8214f8ac43274c04d5166dbb4ba613226adefc305050d48cae6a680cd13941f7
- f1c6af25-0aa9-4c11-9942-006bffd476cf (audit) hash=2c4a4c304e2bc2c51c37697afd58a0366a641456f9e8369b18043a6b51e03801
- d2edf768-0385-47a3-8302-3cd3b03f577b (audit) hash=434b0f6d3ce350a89ea6ed77bff1e59a44d1f507b05634df93f3a4f5cf6242c9
- da5aa988-8e38-4b73-88df-a089e91af550 (audit) hash=648c1e504f8a302d3e9f80a532f0531414f336f05eccc5ab8117afe02da69c6d
- c7f22120-5a6c-4f5a-bb1c-bd9d052237e4 (audit) hash=9cc82572cdf73fe71c4d5a4c15591b3e8a4b9fa0e6b6b6b26f08a4b623c35889
- 75fe8cc1-aed0-484b-b7e9-25e5d8a7b997 (audit) hash=907892e40a783dd93d97a9b69b222213207cf2f3d5064eb467509dd27273bd03
- ba0bac82-a450-40ce-98b6-065e0cfafd5e (audit) hash=f55f6b6566d9742ac5fece135ab8624ff817b8e116cf94d2e6d82418bdd9b4ea
- 7afc2a48-7db8-4671-b992-f09df3047661 (audit) hash=5c5b3fcc44acbc36fedf173131c7d96b8e398dbe8d45aff909bd5ecd28e7a474
- 0c9e319b-33eb-4172-92b9-eb834ecf5c44 (audit) hash=67e8e4862105b17fcfaf6347cc1f9f69ebd086f9a4ce4e35a4acb1e61f6ba9ec
- 46fea7bd-13b1-49e5-9dfd-9bdbbf39196f (audit) hash=d431a88c071366e76c2127d99691d6eb4d4543c0a9038ab153bec7a546f5ef60
What would make this SATISFIED?
- No additional evidence required for this requirement
- Resolve and eliminate audit events: UNSAFE_PROVIDER_ROUTE, MODEL_ROUTE_MISMATCH

### Resource Development (PARTIAL)

Adversary compromises ML supply chain including poisoned models, libraries, and datasets (AML.T0010, AML.T0019).
...
Adversary injects malicious prompts to manipulate LLM behavior and bypass safety controls (AML.T0048).
...
Adversary crafts inputs to evade ML detection or cause misclassification (AML.T0015, AML.T0043).
...
What would make this SATISFIED?
- No additional evidence required for this requirement
- Improve 'injection' score to >= 75 and keep *_SUCCEEDED <= 0

### Evasion (PARTIAL)

Adversary bypasses LLM safety guardrails through crafted multi-turn or encoded prompts (AML.T0051).
...
What would make this SATISFIED?
- No additional evidence required for this requirement
- Improve 'injection' score to >= 85 and keep *_SUCCEEDED <= 0

### Exfiltration (PARTIAL)

Adversary extracts training data, model parameters, or sensitive info via inference API (AML.T0025, AML.T0054).

Deterministic reasons:
- Found 7145 matching events with observed ratio 1.000
...
Adversary exploits ML APIs to consume compute resources and inflate costs (AML.T0034).
...
### ML Model Access (PARTIAL)

Adversary gains unauthorized access to ML model inference or training endpoints (AML.T0040, AML.T0044).
