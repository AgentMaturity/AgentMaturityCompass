...
- [Agent Maturity Compass](https://github.com/AgentMaturity/AgentMaturityCompass) installed with its checksum-verified GitHub Release installer (npm is not public yet)
