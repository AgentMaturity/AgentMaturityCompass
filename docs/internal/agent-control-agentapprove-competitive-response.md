...
| 7 | Build one control projection | Existing policies, Runtime Firewall, approvals | No second policy engine; scope, condition, action project onto existing signed modules |
