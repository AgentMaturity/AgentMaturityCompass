...
- Implementation commit `292f022e17424a1bd325da469fa7dd149dc8930b` is pushed to synchronized `main` / `origin/main`. Exact-SHA CI `29243828095`, Pages `29243828102`, Docker Runner Image `29243828086`, and npm validation `29243828133` passed.
- Production `content-manifest.json` reports exact source revision `292f022e17424a1bd325da469fa7dd149dc8930b` and 173 public guides. Deployed CLI reference SHA-256 `20143be0be9703ca79b1f6b711de2ce81fcc6d86d805a48795e6576d0f726f62` and public OpenAPI SHA-256 `7e486c9fad5b02fac7762740e85feeaacfc09dd8550e7d3223e3e1df1b6485b7` match repository bytes exactly.
- Live quick release receipt `tmp/release-gate/amc-1481-live.json` passed with SHA-256 `f4ed18ad0703d49699e28a988e282ff4f201ed7a66893d9fc77d6e203784763d`.
- Production browser checks passed at 1,440 x 1,000 and 390 x 844 for the homepage, Docs hub, searchable CLI reference, and public OpenAPI. Searching `approvals list` exposed the request query and action-class/time filters at both widths. All four URLs returned HTTP 200 with no console errors, page errors, failed requests, or viewport overflow. Screenshot SHA-256 values are `b7b0cd80b82bf40332d4be300feed7abfc61d8b31c2ce3e81ff04d6a9ba1d502` and `3baad99af8949779abb66f138937e379680eeb7df4fbf172a5711f608e9c4235`.
- Apex HTTPS returned HTTP 200. The Let's Encrypt certificate for `agentmaturity.co` is valid from 2026-06-26 through 2026-09-24 with SHA-256 fingerprint `77:63:2D:AC:EA:01:B7:CE:B8:40:8E:98:A5:CF:21:BE:9E:1D:9D:52:5A:A7:99:37:D9:9A:11:43:0F:B4:D2:79`.
- Publication closeout refreshed current public proof surfaces to 1,077 files / 8,538 tests and made the drift regression reject the prior 8,527 count. The AMC-1481 plus public-stats slice passed 2 files / 14 tests, JavaScript syntax and 1,500-file Docs drift passed, and `tmp/release-gate/amc-1481-closeout-precommit.json` passed syntax, OpenAPI, typecheck, build, architecture, runtime audit, smoke, and live health with SHA-256 `79588b18c919e683cb203711adbeee47d52c7f2972c3e57a20f09a011aaf948a`.
