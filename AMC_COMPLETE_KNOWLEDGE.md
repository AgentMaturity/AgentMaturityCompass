...
- Test counts drift quickly; repository verification on 2026-07-10 recorded 1,047 Vitest files / 8,252 tests
...
- Repository verification on 2026-07-10 recorded `npm test -- --reporter=dot` passing at 1,047 files / 8,252 tests.
...
# Build & test
npm run build
npm test                    # count drifts; repository verification recorded 1,047 files / 8,252 tests on 2026-07-10
npm run typecheck
