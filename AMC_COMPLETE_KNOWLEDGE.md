...
- Test counts drift quickly; repository verification on 2026-07-10 recorded 1,045 Vitest files / 8,238 tests
...
- Repository verification on 2026-07-10 recorded `npm test -- --reporter=dot` passing at 1,045 files / 8,238 tests.
...
# Build & test
npm run build
npm test                    # count drifts; repository verification recorded 1,045 files / 8,238 tests on 2026-07-10
npm run typecheck
